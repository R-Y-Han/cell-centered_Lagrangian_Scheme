...
int main()
{
    ...
    {
        //文件名
        const char* plotv = "cell-centered_Lagrangian_Scheme\\Sedov\\output\\V_Po.plt";    //单元速度
        const char* plotrho = "cell-centered_Lagrangian_Scheme\\Sedov\\output\\rho_Po.plt";    //单元密度
        const char* plotp = "cell-centered_Lagrangian_Scheme\\Sedov\\output\\P_Po.plt";    //单元压力
        const char* plote = "cell-centered_Lagrangian_Scheme\\Sedov\\output\\e_Po.plt";    //单元内能
        const char* point = "cell-centered_Lagrangian_Scheme\\Sedov\\output\\mesh_Po.plt";
