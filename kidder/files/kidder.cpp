...
int main()
{
    ...
    {
        //文件名
        const char* plotr = "cell-centered_Lagrangian_Scheme\\kidder\\output\\r_t.plt";    //单元速度
        const char* plotrho = "cell-centered_Lagrangian_Scheme\\kidder\\output\\rho-t.plt";    //单元密度
        const char* plotrho_end = "cell-centered_Lagrangian_Scheme\\kidder\\output\\density.plt";    //单元压力
        const char* plote = "cell-centered_Lagrangian_Scheme\\kidder\\output\\entropy.plt";    //单元内能
...
void initialmesh()
{
    ...
    for (i=0; i<= nx; i++)
    {
        for (j=0; j<=ny; j++)
        {
            loc[0][i][j][0] = (hx * i + r_1) * cos(j * hy);   //x坐标
            loc[0][i][j][1] = (hx * i + r_1) * sin(j * hy);   //y坐标
